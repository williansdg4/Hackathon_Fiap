...
{
    public class InsertTimeScheduleTest
    {
        ...
        {
            var errors = ValidateModel(new InsertTimeSchedule()
            {
        ...
        [Fact]
        public void InsertTimeSchedule_Validate_Hour()
        {
            var errors = ValidateModel(new InsertTimeSchedule()
            {
                Date = DateTime.MinValue,
        ...
        [Fact]
        public void InsertTimeSchedule_Validate_Hour_InvalidFormat()
        {
            var errors = ValidateModel(new InsertTimeSchedule()
            {
                Date = DateTime.MinValue,
        ...
        [Fact]
        public void InsertTimeSchedule_Validate_Hour_InvalidHour()
        {
            var errors = ValidateModel(new InsertTimeSchedule()
            {
                Date = DateTime.MinValue,
        ...
        [Fact]
        public void InsertTimeSchedule_Validate_Hour_InvalidMinutes()
        {
            var errors = ValidateModel(new InsertTimeSchedule()
            {
                Date = DateTime.MinValue,
